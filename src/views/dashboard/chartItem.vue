    ...
    <el-row :gutter="10">
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-content">￥ 123456</div>
      ...
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-content">12345</div>
          <div class="card-charts">
      ...
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-content">1234</div>
          <div class="card-charts">
      ...
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-content">76%</div>
          <div class="card-charts">
            <div class="charts" ref="progressCharts"></div>
          </div>
          <div class="card-footer">
            <span
              >周好评&nbsp;&nbsp;90%
