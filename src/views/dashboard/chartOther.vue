...
export default {
  ...
  mounted() {
    let lineCharts1 = echarts.init(this.$refs.charts1);
    lineCharts1.setOption({
      xAxis: {
        show: false,
        type: "category",
      },
      ...
      series: [
        {
          type: "line",
          data: [10, 7, 33, 12, 48, 9, 29, 10, 44, 34, 4, 66, 12, 45, 56, 54, 7],
          itemStyle: {
            opacity: 0,
          },
          lineStyle: {
    ...
    let lineCharts2 = echarts.init(this.$refs.charts2);
    lineCharts2.setOption({
      ...
      series: [
        {
          type: "line",
          data: [10, 7, 33, 34, 56, 22, 11, 3, 4, 12, 48, 9, 29, 10, 44],
          itemStyle: {
            opacity: 0,
          },
          lineStyle: {
    ...
    let mychart = echarts.init(this.$refs.charts3);
    mychart.setOption({
      title: {
        text: "视频",
        subtext: 1048,
